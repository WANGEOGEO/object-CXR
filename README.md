...
| 4       |May 27, 2020 | [frankNet-v2](https://github.com/frank-qcd-qk/object-cxr-2020) (single model)  *individual*| 0.935 |0.735|
| 5       |Jun 5, 2020 | GxpNet-single (single model)  *Neusoft*| 0.932 |0.816|
| 6       |Jun 18, 2020 | TimNetV1 (single model) *individual* | 0.930 |0.810|
| 7       |Jun 10, 2020 | faster_rcnn (single model) *TES_Vision* | 0.924 |0.802|
| 8       |Mar 18, 2020 | baseline_faster-rcnn (single model) *individual participant* | 0.923 |0.800|
| 9       |Feb 21, 2020 | [JF Healthcare baseline](https://github.com/jfhealthcare/object-CXR#baseline) (single model)  *JF Healthcare*| 0.921 |0.803|
| 10       |May 27, 2020 | [frankNet](https://github.com/frank-qcd-qk/object-cxr-2020) (single model)  *individual*| 0.918 |0.696|
| 11       |Jun 15, 2020 | EfficientNet (single model)  *SITP*| 0.916 |0.726|
| 12       |Jun 13, 2020 | FrNet (single model) *TES_Vision* | 0.908 |0.759|
| 13       |Jun 18, 2020 | FasterRCNN (single model)  *SITP*| 0.904 |0.729|
